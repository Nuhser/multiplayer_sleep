...
execute as @a[scores={stop_sleeping=1..}] at @s run schedule function multiplayer_sleep:reenable_sleeping 0.5d
...
execute if score $disable_sleeping ms_sleep matches 1.. run function multiplayer_sleep:stop_sleeping
